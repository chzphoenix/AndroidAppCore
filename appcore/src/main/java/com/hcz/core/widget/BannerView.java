...
public class BannerView extends RelativeLayout {
    ...
    private void initAttrs(AttributeSet attrs){
        ...
        mTitlePaddingTop = array.getDimensionPixelSize(R.styleable.BannerView_bannerTitlePaddingTop, DisplayUtils.dip2px(getContext(), 5));
        mTitlePaddingBottom = array.getDimensionPixelSize(R.styleable.BannerView_bannerTitlePaddingBottom, DisplayUtils.dip2px(getContext(), 5));
        mTitlePaddingRight = array.getDimensionPixelSize(R.styleable.BannerView_bannerTitlePaddingRight, 0);
        mTitlePaddingLeft = array.getDimensionPixelSize(R.styleable.BannerView_bannerTitlePaddingLeft, DisplayUtils.dip2px(getContext(), 5));
        mTitleSize = array.getDimensionPixelSize(R.styleable.BannerView_bannerTitleSize, 0);
        mTitleColor = array.getColor(R.styleable.BannerView_bannerTitleColor, TITLE_DEFAULT_COLOR);
        mTitleBackgroundColor = array.getColor(R.styleable.BannerView_bannerTitleBackgroundColor, TITLE_DEFAULT_BG_COLOR);
        mTitleGravity = array.getInt(R.styleable.BannerView_bannerTitleGravity, Gravity.LEFT);

        mIndicatorDrawableRes = array.getResourceId(R.styleable.BannerView_bannerIndicatorDrawable, 0);
        mIndicatorMarginBottom = array.getDimensionPixelSize(R.styleable.BannerView_bannerIndicatorMarginBottom, DisplayUtils.dip2px(getContext(), 5));
        mIndicatorMarginRight = array.getDimensionPixelSize(R.styleable.BannerView_bannerIndicatorMarginRight, 0);
        mIndicatorMarginLeft = array.getDimensionPixelSize(R.styleable.BannerView_bannerIndicatorMarginLeft, 0);
        mIndicatorWidth = array.getDimensionPixelSize(R.styleable.BannerView_bannerIndicatorWidth, LayoutParams.WRAP_CONTENT);
        mIndicatorHeight = array.getDimensionPixelSize(R.styleable.BannerView_bannerIndicatorHeight, LayoutParams.WRAP_CONTENT);
        mIndicatorSpace = array.getDimensionPixelSize(R.styleable.BannerView_bannerIndicatorSpace, DisplayUtils.dip2px(getContext(), 20));
        mIndicatorAlignParentRule = array.getInt(R.styleable.BannerView_bannerIndicatorAlignParentRule, RelativeLayout.CENTER_HORIZONTAL);
    }
