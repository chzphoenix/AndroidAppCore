...
public class Sidebar {
    ...
    public Sidebar(Context context, int float_move, int float_left, int float_right, OnClickListener clickListener){
    ...
    public Sidebar(Context context, Bitmap float_move, Bitmap float_left, Bitmap float_right, OnClickListener clickListener){
        if(context == null){
    ...
    public void showSidebar(){
        if(!isShow){
            ...
            IntentFilter filter = new IntentFilter(Sidebar.ACTION_SIDEBAR_UPDATE);
            ...
            Intent intent = new Intent(Sidebar.ACTION_SIDEBAR_UPDATE);
